...
setup(
    ...
    version=__version__,
    description=u'A CKAN extension that adds a \'status\' bar to the top of the page.',
    ...
    keywords=u'CKAN data status',
    author=u'Natural History Museum',
    author_email=u'data@nhm.ac.uk',
    url=u'https://github.com/NaturalHistoryMuseum/ckanext-status',
    license=u'GNU GPLv3',
